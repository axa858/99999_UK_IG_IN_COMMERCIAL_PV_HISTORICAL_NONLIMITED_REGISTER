 ...
 */
package com.equifax.fabric.uk.nonlimitedregister.history;  
...
public class RawFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder();
  }
  
  /** Creates a new RawFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder newBuilder(com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder other) {
    return new com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder(other);
  }
  
  /** Creates a new RawFields RecordBuilder by copying an existing RawFields instance */
  public static com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder newBuilder(com.equifax.fabric.uk.nonlimitedregister.history.RawFields other) {
    return new com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RawFields>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.nonlimitedregister.history.RawFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.nonlimitedregister.history.RawFields other) {
            super(com.equifax.fabric.uk.nonlimitedregister.history.RawFields.SCHEMA$);
      if (isValidValue(fields()[0], other.BUSINESS_NAME)) {
        this.BUSINESS_NAME = data().deepCopy(fields()[0].schema(), other.BUSINESS_NAME);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'BUSINESS_NAME' field */
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder setBUSINESSNAME(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder clearBUSINESSNAME() {
      BUSINESS_NAME = null;
    ...
    /** Sets the value of the 'ADDRESS' field */
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder setADDRESS(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder clearADDRESS() {
      ADDRESS = null;
    ...
    /** Sets the value of the 'LOCALITY' field */
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder setLOCALITY(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder clearLOCALITY() {
      LOCALITY = null;
    ...
    /** Sets the value of the 'TOWN' field */
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder setTOWN(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder clearTOWN() {
      TOWN = null;
    ...
    /** Sets the value of the 'COUNTY' field */
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder setCOUNTY(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder clearCOUNTY() {
      COUNTY = null;
    ...
    /** Sets the value of the 'POSTCODE' field */
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder setPOSTCODE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.nonlimitedregister.history.RawFields.Builder clearPOSTCODE() {
      POSTCODE = null;
