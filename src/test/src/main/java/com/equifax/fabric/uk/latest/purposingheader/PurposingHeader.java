 ...
 */
package com.equifax.fabric.uk.latest.purposingheader;  
...
public class PurposingHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo> additionalInfo;
   ...
   */
  public PurposingHeader(java.lang.Long dateReported, java.lang.CharSequence recordUuid, java.lang.CharSequence matchKey, java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo> additionalInfo) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: additionalInfo = (java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo> getAdditionalInfo() {
   ...
   * @param value the value to set.
   */
  public void setAdditionalInfo(java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo> value) {
    this.additionalInfo = value;
  }

  /** Creates a new PurposingHeader RecordBuilder */
  public static com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder newBuilder() {
    return new com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder();
  }
  
  /** Creates a new PurposingHeader RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder newBuilder(com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder other) {
    return new com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder(other);
  }
  
  /** Creates a new PurposingHeader RecordBuilder by copying an existing PurposingHeader instance */
  public static com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder newBuilder(com.equifax.fabric.uk.latest.purposingheader.PurposingHeader other) {
    return new com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PurposingHeader>
    ...
    private java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo> additionalInfo;

    /** Creates a new Builder */
    private Builder() {
      super(com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.latest.purposingheader.PurposingHeader other) {
            super(com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.SCHEMA$);
      if (isValidValue(fields()[0], other.dateReported)) {
        this.dateReported = data().deepCopy(fields()[0].schema(), other.dateReported);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'dateReported' field */
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder setDateReported(java.lang.Long value) {
    ...
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder clearDateReported() {
      dateReported = null;
    ...
    /** Sets the value of the 'recordUuid' field */
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder setRecordUuid(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder clearRecordUuid() {
      recordUuid = null;
    ...
    /** Sets the value of the 'matchKey' field */
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder setMatchKey(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder clearMatchKey() {
      matchKey = null;
    ...
    /** Sets the value of the 'additionalInfo' field */
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder setAdditionalInfo(java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo> value) {
    ...
    public com.equifax.fabric.uk.latest.purposingheader.PurposingHeader.Builder clearAdditionalInfo() {
      additionalInfo = null;
    ...
    public PurposingHeader build() {
      try {
        ...
        record.additionalInfo = fieldSetFlags()[3] ? this.additionalInfo : (java.util.List<com.equifax.fabric.uk.latest.purposingheader.additionalInfo>) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
