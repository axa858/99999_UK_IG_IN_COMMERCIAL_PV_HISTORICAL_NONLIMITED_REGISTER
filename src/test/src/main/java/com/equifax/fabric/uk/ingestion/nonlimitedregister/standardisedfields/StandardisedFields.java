 ...
 */
package com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields;  
...
public class StandardisedFields extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder newBuilder() {
    return new com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder();
  }
  
  /** Creates a new StandardisedFields RecordBuilder by copying an existing Builder */
  public static com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder other) {
    return new com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder(other);
  }
  
  /** Creates a new StandardisedFields RecordBuilder by copying an existing StandardisedFields instance */
  public static com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder newBuilder(com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields other) {
    return new com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StandardisedFields>
    ...
    private Builder() {
      super(com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder other) {
      super(other);
    ...
    private Builder(com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields other) {
            super(com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.SCHEMA$);
      if (isValidValue(fields()[0], other.BUSINESS_INDEX_ID)) {
        this.BUSINESS_INDEX_ID = data().deepCopy(fields()[0].schema(), other.BUSINESS_INDEX_ID);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'BUSINESS_INDEX_ID' field */
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder setBUSINESSINDEXID(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder clearBUSINESSINDEXID() {
    ...
    /** Sets the value of the 'BUSINESS_NAME' field */
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder setBUSINESSNAME(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder clearBUSINESSNAME() {
      BUSINESS_NAME = null;
    ...
    /** Sets the value of the 'PROCESSING_DATE' field */
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder setPROCESSINGDATE(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder clearPROCESSINGDATE() {
    ...
    /** Sets the value of the 'FORMAT_OF_SUPPLY' field */
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder setFORMATOFSUPPLY(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder clearFORMATOFSUPPLY() {
    ...
    /** Sets the value of the 'MIGRATION_FLAG' field */
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder setMIGRATIONFLAG(java.lang.CharSequence value) {
    ...
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder clearMIGRATIONFLAG() {
      MIGRATION_FLAG = null;
    ...
    /** Sets the value of the 'entity' field */
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder setEntity(com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.entity.entityFields value) {
    ...
    public com.equifax.fabric.uk.ingestion.nonlimitedregister.standardisedfields.StandardisedFields.Builder clearEntity() {
      entity = null;
